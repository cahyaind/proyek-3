			...
			<div class="vertical-align-middle">
				<div class="auth-box ">
					<div class="left">
						<div class="content">
							<div class="header">
								<div class="logo text-center"><a href="/"><img src="{{asset('logo-simater.png')}}" alt="Klorofil Logo"></a></div>
								<p class="lead"><b>Register</b></p>
							</div>
							<form class="form-auth-small" action="/postregister" method="POST">
								...
								<br>Sudah punya akun? <a href="/login">Login</a>
							</form>
						</div>
					</div>
					<div class="right">
						...
						<div class="content text">
							<h1 class="heading">Sistem Manajemen Peternakan Ayam</h1>
							<p>Pak Giman</p>
						</div>
					</div>
